...
class Faculty(TimeStampedModel):
	...
	modified_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, related_name='%(class)s_modified_by')
...
class Employee(TimeStampedModel):
    ...
    active_status = models.CharField(max_length=10,choices=ACTIVE_STATUS, default='a')

    faculty =models.ForeignKey(Faculty, on_delete=models.PROTECT, related_name='faculty', blank=True, null=True)
    department =models.ForeignKey(Department, on_delete=models.PROTECT, related_name='department', blank=True, null=True)
    userType =models.ForeignKey(UserType, on_delete=models.PROTECT, related_name='userType', blank=True, null=True)
    designation =models.ForeignKey(Designation, on_delete=models.PROTECT, related_name='designation', blank=True, null=True)
    slug = models.SlugField(editable=False)
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, related_name='%(class)s_created_by')
    modified_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, related_name='%(class)s_modified_by')
